...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Cubic.lnk";
}
...
{
    return GetAutostartDir() / "cubic.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Cubic-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  cubic-qt [" + tr("command-line options") + "]                     " + "\n";
